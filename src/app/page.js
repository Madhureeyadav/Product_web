...
export default function Home() {
  return (  
 <div>
  <Image src="/img/g3.jpg" width={100} height={100} className="w-full h-64 "></Image>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      ...
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">wear Whatever you want ? what do you want ? youwant code? so why not wear the code</p>
    </div>
...
<Link href="/Product/[Id].js" ><h1>Home Page</h1></Link>
